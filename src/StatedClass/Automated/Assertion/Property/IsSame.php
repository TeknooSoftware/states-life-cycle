...
/**
 * class IsSame
 * Invokable class to use with Teknoo\States\LifeCycle\StatedClass\Automated\Assertion to check if a propery has the
 ...
 * @author      Richard Déloge <richarddeloge@gmail.com>
 */
class IsSame implements ImmutableInterface
{
    use ImmutableTrait;
