 ...
 * Class IsNotNullTest.
 *
 * @covers \Teknoo\States\LifeCycle\StatedClass\Automated\Assertion\Property\IsNotNull
 *
 * @copyright   Copyright (c) 2009-2016 Richard Déloge (richarddeloge@gmail.com)
 *
 * @link        http://teknoo.software/states Project website
...
class IsNotNullTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        self::assertTrue($this->buildInstance()(''));
    }

    public function testNullProperty()
    {
        self::assertFalse($this->buildInstance()(null));
    }
}
