 ...
 *
 * @covers \Teknoo\States\LifeCycle\StatedClass\Automated\Assertion\Property\IsInstanceOf
 *
 * @copyright   Copyright (c) 2009-2017 Richard Déloge (richarddeloge@gmail.com)
 *
 * @link        http://teknoo.software/states Project website
...
class IsInstanceOfTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        self::assertTrue($this->buildInstance()(new \DateTime()));
    }

    public function testNotInstanceOfProperty()
    {
        self::assertFalse($this->buildInstance()(new \stdClass()));
    }
}
